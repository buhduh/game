...
namespace graphics {
	...
	class Vulkan  {
		...
		//i think these are more or less static through the lifetime of the
		//process
		VkImage guiTextureImage;
		VkDeviceMemory guiTextureImageMemory;
		VkImageView guiTextureImageView;
